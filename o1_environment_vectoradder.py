...
class RefineEnv(BaseEnv):
    ...
    def get_ppa_full_delay_cons(self, test_state):
        ...
        target_delay=[]
        input_width = math.ceil(self.width)
        if input_width == 8:
...
if __name__ == '__main__':
    env = RefineEnv(
        1, None, mul_booth_file="mul.test2", num=8,width=8,
        target_delay=[50,250,400,650], initial_state_pool_max_len=20,load_pool_index=3, reward_type="simulate",
